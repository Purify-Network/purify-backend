#!/usr/bin/env bash
#########################################
#  Start aqua database docker container
#########################################
...
DATABASE_PASSWORD="changeMeToCorrectPassword"
LOCAL_INITDB_DIR="$PARENT_DIR/migrations"
LOCAL_ADHOC_SCRIPTS_DIR="$PARENT_DIR/scripts"
